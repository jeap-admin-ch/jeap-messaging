...
import static ch.admin.bit.jeap.messaging.annotations.ConsumerContractByMessagesFileAnnotationTest.APP_NAME;
...
@JeapMessageConsumerContractsByTemplates(
        appName = APP_NAME,
        templatesPath = "messages"
)
public class ConsumerContractByMessagesFileAnnotationTest {

    public static final String APP_NAME = "appNameForMessagesFileTest";
    ...
    void generatedContractJsonIsCorrect() throws Exception {
        ...
        JSONAssert.assertEquals("{appName:\"" + APP_NAME + "\"}", actual, false);
        JSONAssert.assertEquals("{topics: [ \"messages-topic1\" ]}", actual, false);
    }
}
