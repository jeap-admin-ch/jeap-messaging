...
@JeapMessageConsumerContract(value = TypeRefExamples.TypeRef1.class, appName = SingleConsumerContractAnnotationTest.APP_NAME, topic = {"topic1", "topic2"})
class SingleConsumerContractAnnotationTest {
    ...
    void generatedContractFileExists() {
        String expectedName = APP_NAME + "-" + TypeRefExamples.TypeRef1.MESSAGE_TYPE_NAME + "-" + TypeRefExamples.TypeRef1.MESSAGE_TYPE_VERSION + ".consumer-contract.json";
