...
@SpringBootTest(
        ...
        properties = {
                ...
                "jeap.messaging.kafka.cluster.cloud.aws.msk.iam-auth-enabled=true",
                "jeap.messaging.kafka.cluster.cloud.aws.msk.assume-iam-role-arn=arn:foo:bar",
                "jeap.messaging.kafka.cluster.cloud.aws.msk.region=eu-test-1"
        }
)
...
class AwsMskKafkaAuthPropertiesAssumeRoleTest {
    ...
    void authenticationProperties() {
        Map<String, Object> props = kafkaAuthProperties.authenticationProperties("cloud");
        ...
        assertThat(props)
                ...
                .containsEntry(SaslConfigs.SASL_JAAS_CONFIG, """
                        software.amazon.msk.auth.iam.IAMLoginModule required awsRoleArn="arn:foo:bar" awsRoleSessionName="testapp" awsStsRegion="eu-test-1";""")
