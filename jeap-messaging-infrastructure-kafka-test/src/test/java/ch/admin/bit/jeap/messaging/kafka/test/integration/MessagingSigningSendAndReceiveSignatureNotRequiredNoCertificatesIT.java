...
// The messages are signed, there are no certificates on the subscriber side, so the signature cannot be validated, but as we are in non-strict mode, the message is accepted
@DirtiesContext
class MessagingSigningSendAndReceiveSignatureNotRequiredNoCertificatesIT extends KafkaIntegrationTestBase {
